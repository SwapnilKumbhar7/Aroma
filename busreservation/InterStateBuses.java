...
public class InterStateBuses extends JFrame
{
	...
	public InterStateBuses(LoginPage type1)
	{
		...
		BFindBus.setBounds(50,270,100,25);
	...
	public static void main(String args[])
	{
		...
		new InterStateBuses(type1);
	}
}

class button2 implements ActionListener
{
	InterStateBuses type;
	LoginPage type1;
	button2(InterStateBuses type, LoginPage type1)
	{
		this.type = type;
		this.type1 = type1;
	}
