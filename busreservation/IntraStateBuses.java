...
public class IntraStateBuses extends JFrame
{
	...
	public IntraStateBuses(LoginPage type1)
	{
	...
	public static void main(String args[])
	{
		...
		new IntraStateBuses(type1);
	}
}

class button3 implements ActionListener
{
	IntraStateBuses type;
	LoginPage type1;
	button3(IntraStateBuses type, LoginPage type1)
	{
		this.type = type;
		this.type1 = type1;
	}
